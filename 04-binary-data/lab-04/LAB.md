...
* Work in a feature branch, submit link to Pull Request from feature branch to your master. 
...
## Testing 
* Use `describe` and `test` methods to define discriptive tests and increase readablity
